...
export PATH="$PATH:/home/jay/.cargo/bin"
...
alias lf='exa -l -all --group-directories-first'
alias lm='exa -l --sort old --group-directories-first'
...
# Vim Mode
source /usr/share/zsh/plugins/vi-mode/vi-mode.zsh
# Enable coolguy fonts
# source ~/.fonts/*.sh
